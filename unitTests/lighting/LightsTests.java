...
public class LightsTests
{
	...
	private final Geometry sphere =
			new Sphere(SPHERE_RADIUS, sphereCenter)
	...
	public void sphereMultipleLight()
	{
		...
		ImageWriter imageWriter = new ImageWriter("sphereMultipleLight", 500, 500);
		camera1.setImageWriter(imageWriter) //
				.setRayTracer(new RayTracerBasic(scene1)) //
				.renderImage() //
				.writeToImage(); //
	...
	public void trianglesMultipleLight()
	{
		...
		ImageWriter imageWriter = new ImageWriter("trianglesMultipleLight", 500, 500);
		camera2.setImageWriter(imageWriter) //
				.setRayTracer(new RayTracerBasic(scene2)) //
				.renderImage() //
				.writeToImage(); //
