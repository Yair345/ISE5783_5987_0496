...
public class PolygonTests
{
	...
	{
		Polygon polygon = new Polygon(new Point(2, 0, 0), new Point(0, 2, 0), new Point(-2, 0, 0), new Point(0,-2,0));
		...
		assertEquals(List.of(new Point(0, 0.5, 1)), result01, "Ray crosses polygon 01");
