...
/**
 * This class is a JUnit test class for the {@link Geometries#findIntersections(Ray)} method.
 *
...
class GeometriesTests
{
	...
	void testFindIntersections()
	{
		Geometries g = new Geometries(new Sphere(2, new Point(0, 0, 0)),
				new Plane(new Point(0, 0, -3), new Point(1, 0, 3), new Point(1, 1, -3)),
				new Triangle(new Point(3, 0, 0), new Point(0, 3, 0), new Point(2, 2, 3)),
				new Polygon(new Point(-4, 0, -1), new Point(0, -4, 0), new Point(0, -4, 3), new Point(-4, 0, 2)));
